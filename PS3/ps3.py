...
class RectangularRoom(object):
    ...
    def __init__(self, width, height, dirt_amount):
        ...
        self.tiles = {(x, y): dirt_amount for x in range(self.width) for y in range(self.height)}
    ...
    def clean_tile_at_position(self, pos, capacity):
        ...
        self.tiles[(math.floor(pos.get_x()), math.floor(pos.get_y()))] -= capacity \
            if capacity <= self.tiles[(math.floor(pos.get_x()), math.floor(pos.get_y()))] else 0
    ...
    def get_num_cleaned_tiles(self):
        ...
        """
        return len([tile_num for tile_num in self.tiles.values() if tile_num == 0])
...
class Robot(object):
    ...
    def __init__(self, room, speed, capacity):
        ...
        self.direction = float(360 * random.random())
...
class StandardRobot(Robot):
    ...
    def update_position_and_clean(self):
        ...
        """
        new_pos = self.position.get_new_position(self.get_robot_direction(), self.speed)
...
def run_simulation(num_robots, speed, capacity, width, height, dirt_amount, min_coverage, num_trials,
    ...
    for trial in range(num_trials):
        ...
        robots = [robot_type(room, speed, capacity) for num in range(num_robots)]
        # Animation code #
        ...
        # anim.done()
    avg_time_steps = sum(time_steps_list) / len(time_steps_list)
...
#
# print ('avg time steps: ' + str(run_simulation(1, 1.0, 1, 10, 30, 3, 0.8, 50, StandardRobot)))
# print ('avg time steps: ' + str(run_simulation(1, 1.0, 1, 20, 15, 3, 0.8, 50, StandardRobot)))
# print ('avg time steps: ' + str(run_simulation(1, 1.0, 1, 25, 12, 3, 0.8, 50, StandardRobot)))
#
# print ('avg time steps: ' + str(run_simulation(1, 1.0, 1, 10, 30, 3, 0.8, 50, FaultyRobot)))
# print ('avg time steps: ' + str(run_simulation(1, 1.0, 1, 20, 15, 3, 0.8, 50, FaultyRobot)))
# print ('avg time steps: ' + str(run_simulation(1, 1.0, 1, 25, 12, 3, 0.8, 50, FaultyRobot)))
